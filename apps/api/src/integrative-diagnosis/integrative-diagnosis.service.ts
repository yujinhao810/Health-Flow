...
export class IntegrativeDiagnosisService {
  ...
  async create(user: AuthUser, input: unknown) {
    ...
    try {
      ...
      await this.agentRuns.addStep(agentRun.id, { type: 'western_initial', title: '西医 Agent 初评', status: westernGeneration.status, data: { warning: westernGeneration.warning, output: westernGeneration.value } });
      await this.agentRuns.addStep(agentRun.id, { type: 'tcm_initial', title: '中医 Agent 初评', status: tcmGeneration.status, data: { warning: tcmGeneration.warning, output: tcmGeneration.value } });
      ...
      await this.agentRuns.addStep(agentRun.id, { type: 'western_cross', title: '西医 Agent 质询中医结果', status: westernCrossGeneration.status, data: { warning: westernCrossGeneration.warning, output: westernCrossGeneration.value } });
      await this.agentRuns.addStep(agentRun.id, { type: 'tcm_cross', title: '中医 Agent 质询西医结果', status: tcmCrossGeneration.status, data: { warning: tcmCrossGeneration.warning, output: tcmCrossGeneration.value } });
      ...
      await this.agentRuns.addStep(agentRun.id, { type: 'integrator', title: '决策者 Agent 仲裁结果', status: integratedGeneration.status, data: { warning: integratedGeneration.warning, output: integratedGeneration.value } });
